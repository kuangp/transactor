package transactor.examples.reference_cell;
...
public class cell_tester extends Transactor {
	public static void main(String args[]) {
		...
		cell_tester instance = (cell_tester)new cell_tester(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new cell_tester(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return cell_tester.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new cell_tester(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return cell_tester.getReferenceByLocation(new UAL(ual)); }
	public cell_tester(boolean o, UAN __uan)	{ super(false,__uan); }
	public cell_tester(boolean o, UAL __ual)	{ super(false,__ual); }
	public cell_tester(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public cell_tester(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public cell_tester(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public cell_tester()		{  }
	public cell_tester(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.reference_cell.cell_tester", sourceRef);
			  }
	...
	public class State extends Transactor.State {
		public cell_tester self;
		public void updateSelf(ActorReference actorReference) {
			((cell_tester)actorReference).setUAL(getUAL());
			((cell_tester)actorReference).setUAN(getUAN());
			self = new cell_tester(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.reference_cell.cell_tester$State" );
