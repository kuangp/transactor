...
public class pcell extends Transactor {
	public static void main(String args[]) {
		...
		pcell instance = (pcell)new pcell(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new pcell(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return pcell.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new pcell(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return pcell.getReferenceByLocation(new UAL(ual)); }
	public pcell(boolean o, UAN __uan)	{ super(false,__uan); }
	public pcell(boolean o, UAL __ual)	{ super(false,__ual); }
	public pcell(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public pcell(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public pcell(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public pcell()		{  }
	public pcell(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.reference_cell.pcell", sourceRef);
			  }
	...
	public class State extends Transactor.State {
		...
		public void updateSelf(ActorReference actorReference) {
			((pcell)actorReference).setUAL(getUAL());
			((pcell)actorReference).setUAN(getUAN());
			self = new pcell(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.reference_cell.pcell$State" );
