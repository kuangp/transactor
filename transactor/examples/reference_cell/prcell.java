...
public class prcell extends Transactor {
	public static void main(String args[]) {
		...
		prcell instance = (prcell)new prcell(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new prcell(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return prcell.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new prcell(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return prcell.getReferenceByLocation(new UAL(ual)); }
	public prcell(boolean o, UAN __uan)	{ super(false,__uan); }
	public prcell(boolean o, UAL __ual)	{ super(false,__ual); }
	public prcell(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public prcell(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public prcell(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public prcell()		{  }
	public prcell(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.reference_cell.prcell", sourceRef);
			  }
	...
	public UniversalActor construct (int contents) {
		Object[] __arguments = { new Integer(contents) };
	...
	public class State extends Transactor.State {
		...
		public void updateSelf(ActorReference actorReference) {
			((prcell)actorReference).setUAL(getUAL());
			((prcell)actorReference).setUAN(getUAN());
			self = new prcell(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.reference_cell.prcell$State" );
