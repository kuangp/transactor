package transactor.examples.bank_transfer_2;
...
public class bankaccount extends Transactor {
	public static void main(String args[]) {
		...
		bankaccount instance = (bankaccount)new bankaccount(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new bankaccount(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return bankaccount.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new bankaccount(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return bankaccount.getReferenceByLocation(new UAL(ual)); }
	public bankaccount(boolean o, UAN __uan)	{ super(false,__uan); }
	public bankaccount(boolean o, UAL __ual)	{ super(false,__ual); }
	public bankaccount(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public bankaccount(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public bankaccount(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public bankaccount()		{  }
	public bankaccount(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.bank_transfer_2.bankaccount", sourceRef);
			  }
	...
	public UniversalActor construct (int balance) {
		Object[] __arguments = { new Integer(balance) };
	...
	public class State extends Transactor.State {
		public bankaccount self;
		public void updateSelf(ActorReference actorReference) {
			((bankaccount)actorReference).setUAL(getUAL());
			((bankaccount)actorReference).setUAN(getUAN());
			self = new bankaccount(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.bank_transfer_2.bankaccount$State" );
