...
public class transfer extends Transactor {
	...
	public transfer(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.bank_transfer_2.transfer", sourceRef);
			  }
	...
	public class State extends Transactor.State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.bank_transfer_2.transfer$State" );
		...
		public void act(String[] args) {
			...
			this.setTState("banker", atm);
			{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, savings, "initialize", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// checking<-initialize()
				{
					Object _arguments[] = {  };
					Message message = new Message( self, checking, "initialize", _arguments, token_2_0, token_2_1 );
					__messages.add( message );
				}
				// atm<-initialize()
				{
					Object _arguments[] = {  };
					Message message = new Message( self, atm, "initialize", _arguments, token_2_1, token_2_2 );
					__messages.add( message );
				}
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, savings, "printData", _arguments, token_2_3, token_2_4 );
					__messages.add( message );
				}
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, checking, "printData", _arguments, token_2_5, token_2_6 );
					__messages.add( message );
				}
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, atm, "printData", _arguments, token_2_7, token_2_8 );
					__messages.add( message );
				}
				// ((transfer)self)<-fund()
				{
					Object _arguments[] = {  };
					Message message = new Message( self, ((transfer)self), "fund", _arguments, token_2_8, token_2_9 );
					__messages.add( message );
				}
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, savings, "printData", _arguments, token_2_11, token_2_12 );
					__messages.add( message );
				}
				// standardOutput<-println()
				{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, checking, "printData", _arguments, token_2_14, token_2_15 );
					__messages.add( message );
				}
				// standardOutput<-println()
				{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, atm, "printData", _arguments, token_2_17, null );
					__messages.add( message );
				}
			}
		}
