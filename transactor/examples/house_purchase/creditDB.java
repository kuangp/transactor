...
public class creditDB extends Proxy {
	public static void main(String args[]) {
		...
		creditDB instance = (creditDB)new creditDB(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new creditDB(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return creditDB.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new creditDB(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return creditDB.getReferenceByLocation(new UAL(ual)); }
	public creditDB(boolean o, UAN __uan)	{ super(false,__uan); }
	public creditDB(boolean o, UAL __ual)	{ super(false,__ual); }
	public creditDB(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public creditDB(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public creditDB(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public creditDB()		{  }
	public creditDB(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.house_purchase.creditDB", sourceRef);
			  }
	...
	public class State extends Proxy.State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((creditDB)actorReference).setUAN(getUAN());
			self = new creditDB(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.house_purchase.creditDB$State" );
