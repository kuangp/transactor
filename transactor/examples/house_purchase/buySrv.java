...
public class buySrv extends Transactor {
	public static void main(String args[]) {
		...
		buySrv instance = (buySrv)new buySrv(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new buySrv(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return buySrv.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new buySrv(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return buySrv.getReferenceByLocation(new UAL(ual)); }
	public buySrv(boolean o, UAN __uan)	{ super(false,__uan); }
	public buySrv(boolean o, UAL __ual)	{ super(false,__ual); }
	public buySrv(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public buySrv(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public buySrv(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public buySrv()		{  }
	public buySrv(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.house_purchase.buySrv", sourceRef);
			  }
	...
	public UniversalActor construct (searchSrv searcher, apprSrv appraiser, sellSrv seller, lendSrv lender, verifySrv verifier, creditDB creditHistory) {
		Object[] __arguments = { searcher, appraiser, seller, lender, verifier, creditHistory };
	...
	public class State extends Transactor.State {
		...
		public void updateSelf(ActorReference actorReference) {
			((buySrv)actorReference).setUAL(getUAL());
			((buySrv)actorReference).setUAN(getUAN());
			self = new buySrv(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.house_purchase.buySrv$State" );
		...
		String title;
		String mortgage;
		public void construct(searchSrv searcher, apprSrv appraiser, sellSrv seller, lendSrv lender, verifySrv verifier, creditDB creditHistory){
			super.construct( (((buySrv)self)) );
