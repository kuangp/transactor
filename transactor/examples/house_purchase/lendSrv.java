...
public class lendSrv extends Transactor {
	public static void main(String args[]) {
		...
		lendSrv instance = (lendSrv)new lendSrv(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new lendSrv(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return lendSrv.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new lendSrv(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return lendSrv.getReferenceByLocation(new UAL(ual)); }
	public lendSrv(boolean o, UAN __uan)	{ super(false,__uan); }
	public lendSrv(boolean o, UAL __ual)	{ super(false,__ual); }
	public lendSrv(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public lendSrv(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public lendSrv(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public lendSrv()		{  }
	public lendSrv(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.house_purchase.lendSrv", sourceRef);
			  }
	...
	public class State extends Transactor.State {
		...
		public void updateSelf(ActorReference actorReference) {
			((lendSrv)actorReference).setUAL(getUAL());
			((lendSrv)actorReference).setUAN(getUAN());
			self = new lendSrv(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.house_purchase.lendSrv$State" );
