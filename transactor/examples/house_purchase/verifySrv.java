...
public class verifySrv extends Transactor {
	public static void main(String args[]) {
		...
		verifySrv instance = (verifySrv)new verifySrv(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new verifySrv(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return verifySrv.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new verifySrv(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return verifySrv.getReferenceByLocation(new UAL(ual)); }
	public verifySrv(boolean o, UAN __uan)	{ super(false,__uan); }
	public verifySrv(boolean o, UAL __ual)	{ super(false,__ual); }
	public verifySrv(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public verifySrv(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public verifySrv(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public verifySrv()		{  }
	public verifySrv(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.house_purchase.verifySrv", sourceRef);
			  }
	...
	public UniversalActor construct (HashMap specs, HashMap prices) {
		Object[] __arguments = { specs, prices };
	...
	public class State extends Transactor.State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((verifySrv)actorReference).setUAN(getUAN());
			self = new verifySrv(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.house_purchase.verifySrv$State" );
		...
		HashMap specs;
		HashMap prices;
		public void construct(HashMap specs, HashMap prices){
			super.construct( (((verifySrv)self)) );
