...
public class searchSrv extends Transactor {
	public static void main(String args[]) {
		...
		searchSrv instance = (searchSrv)new searchSrv(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new searchSrv(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return searchSrv.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new searchSrv(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return searchSrv.getReferenceByLocation(new UAL(ual)); }
	public searchSrv(boolean o, UAN __uan)	{ super(false,__uan); }
	public searchSrv(boolean o, UAL __ual)	{ super(false,__ual); }
	public searchSrv(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public searchSrv(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public searchSrv(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public searchSrv()		{  }
	public searchSrv(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.house_purchase.searchSrv", sourceRef);
			  }
	...
	public UniversalActor construct (HashMap titlesInfo) {
		Object[] __arguments = { titlesInfo };
	...
	public class State extends Transactor.State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((searchSrv)actorReference).setUAN(getUAN());
			self = new searchSrv(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.house_purchase.searchSrv$State" );
		...
		HashMap titlesDB;
		public void construct(HashMap titlesInfo){
			super.construct( (((searchSrv)self)) );
