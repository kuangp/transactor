...
public class sellSrv extends Transactor {
	public static void main(String args[]) {
		...
		sellSrv instance = (sellSrv)new sellSrv(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new sellSrv(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return sellSrv.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new sellSrv(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return sellSrv.getReferenceByLocation(new UAL(ual)); }
	public sellSrv(boolean o, UAN __uan)	{ super(false,__uan); }
	public sellSrv(boolean o, UAL __ual)	{ super(false,__ual); }
	public sellSrv(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public sellSrv(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public sellSrv(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public sellSrv()		{  }
	public sellSrv(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.house_purchase.sellSrv", sourceRef);
			  }
	...
	public UniversalActor construct (HashMap specsInfo, HashMap mins) {
		Object[] __arguments = { specsInfo, mins };
	...
	public class State extends Transactor.State {
		...
		public void updateSelf(ActorReference actorReference) {
			((sellSrv)actorReference).setUAL(getUAL());
			((sellSrv)actorReference).setUAN(getUAN());
			self = new sellSrv(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.house_purchase.sellSrv$State" );
		...
		int offeredPrice = 0;
		HashMap specs;
		public void construct(HashMap specsInfo, HashMap mins){
			super.construct( (((sellSrv)self)) );
