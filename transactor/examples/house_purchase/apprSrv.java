...
public class apprSrv extends Transactor {
	public static void main(String args[]) {
		...
		apprSrv instance = (apprSrv)new apprSrv(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new apprSrv(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return apprSrv.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new apprSrv(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return apprSrv.getReferenceByLocation(new UAL(ual)); }
	public apprSrv(boolean o, UAN __uan)	{ super(false,__uan); }
	public apprSrv(boolean o, UAL __ual)	{ super(false,__ual); }
	public apprSrv(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public apprSrv(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public apprSrv(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public apprSrv()		{  }
	public apprSrv(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "transactor.examples.house_purchase.apprSrv", sourceRef);
			  }
	...
	public class State extends Transactor.State {
		...
		public void updateSelf(ActorReference actorReference) {
			((apprSrv)actorReference).setUAL(getUAL());
			((apprSrv)actorReference).setUAN(getUAN());
			self = new apprSrv(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "transactor.examples.house_purchase.apprSrv$State" );
