...
public class StandardInput extends UniversalActor  implements InputService {
	public static void main(String args[]) {
		...
		StandardInput instance = (StandardInput)new StandardInput(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new StandardInput(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return StandardInput.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new StandardInput(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return StandardInput.getReferenceByLocation(new UAL(ual)); }
	public StandardInput(boolean o, UAN __uan)	{ super(false,__uan); }
	public StandardInput(boolean o, UAL __ual)	{ super(false,__ual); }
	public StandardInput(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public StandardInput(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public StandardInput(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public StandardInput()		{  }
	public StandardInput(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "wwc.resources.StandardInput", sourceRef);
			  }
	...
	public class State extends UniversalActor .State implements InputService.State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			self = new StandardInput(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
